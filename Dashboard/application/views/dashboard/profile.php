...
<div class="pqrt1">
   <h1>Edit user</h1>
    ...
    <a href="<?php echo base_url();?>dashboard"><i class="fa fa-circle-o"></i> Dashboard v2</a>
        ...
        <a href="<?php echo base_url();?>users/profile">Profile</a>
               ...
               <a href="<?php echo base_url();?>users/edit_profile">Edit</a>
        </li>
        </ul>
</div>
  ...
  <div class="main">
        ...
        <tr>
        <td class="photo"><img src="<?php echo base_url();?>libs/img/sss.jpg" width="150"></td>
          <td>
          <h3><?php  echo $ed->username ?></h3> <!-- Jhone Doe name -->
